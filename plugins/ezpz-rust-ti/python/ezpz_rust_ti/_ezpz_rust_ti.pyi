...
class CandleTI:
    ...
    def mcginley_dynamic_envelopes_single(self, difference:builtins.float, previous_mcginley_dynamic:builtins.float) -> polars.DataFrame:
        ...
        """
    def moving_constant_bands_single(self, constant_model_type:builtins.str, deviation_model:builtins.str, deviation_multiplier:builtins.float) -> polars.DataFrame:
        r"""
        ...
        """
    def mcginley_dynamic_bands_single(self, deviation_model:builtins.str, deviation_multiplier:builtins.float, previous_mcginley_dynamic:builtins.float) -> polars.DataFrame:
        r"""
        ...
        """
    def ichimoku_cloud_single(self, highs:polars.Series, lows:polars.Series, conversion_period:builtins.int, base_period:builtins.int, span_b_period:builtins.int) -> polars.DataFrame:
        r"""
    ...
    def donchian_channels_single(self, highs:polars.Series, lows:polars.Series) -> polars.DataFrame:
        ...
        """
    def keltner_channel_single(self, highs:polars.Series, lows:polars.Series, constant_model_type:builtins.str, atr_constant_model_type:builtins.str, multiplier:builtins.float) -> polars.DataFrame:
        r"""
    ...
    def mcginley_dynamic_envelopes_bulk(self, difference:builtins.float, previous_mcginley_dynamic:builtins.float, period:builtins.int) -> polars.DataFrame:
        ...
        - `upper_envelope`: Vec<f64> - Time series of upper envelope bands
        """
    def moving_constant_bands_bulk(self, constant_model_type:builtins.str, deviation_model:builtins.str, deviation_multiplier:builtins.float, period:builtins.int) -> polars.DataFrame:
        r"""
        ...
        """
    def mcginley_dynamic_bands_bulk(self, deviation_model:builtins.str, deviation_multiplier:builtins.float, previous_mcginley_dynamic:builtins.float, period:builtins.int) -> polars.DataFrame:
        r"""
        ...
        - `upper_band`: Vec<f64> - Time series of upper bands
        """
    def ichimoku_cloud_bulk(self, highs:polars.Series, lows:polars.Series, conversion_period:builtins.int, base_period:builtins.int, span_b_period:builtins.int) -> polars.DataFrame:
        r"""
    ...
    def donchian_channels_bulk(self, highs:polars.Series, lows:polars.Series, period:builtins.int) -> polars.DataFrame:
        ...
        """
    def keltner_channel_bulk(self, highs:polars.Series, lows:polars.Series, constant_model_type:builtins.str, atr_constant_model_type:builtins.str, multiplier:builtins.float, period:builtins.int) -> polars.DataFrame:
        r"""
        ...
        """
    def supertrend_bulk(self, highs:polars.Series, lows:polars.Series, constant_model_type:builtins.str, multiplier:builtins.float, period:builtins.int) -> polars.Series:
        r"""
...
class ChartTrendsTI:
    ...
    def overall_trend(self) -> tuple[builtins.float, builtins.float]:
        ...
        - `intercept`: The y-intercept of the linear regression line
        """
    def break_down_trends(self, max_outliers:builtins.int, soft_r_squared_minimum:builtins.float, soft_r_squared_maximum:builtins.float, hard_r_squared_minimum:builtins.float, hard_r_squared_maximum:builtins.float, soft_standard_error_multiplier:builtins.float, hard_standard_error_multiplier:builtins.float, soft_reduced_chi_squared_multiplier:builtins.float, hard_reduced_chi_squared_multiplier:builtins.float) -> builtins.list[tuple[builtins.int, builtins.int, builtins.float, builtins.float]]:
        r"""
...
class CorrelationTI:
    ...
    def correlate_asset_prices_single(self, other_asset_prices:polars.Series, constant_model_type:builtins.str, deviation_model:builtins.str) -> builtins.float:
        r"""
        ...
        """
    def correlate_asset_prices_bulk(self, other_asset_prices:polars.Series, constant_model_type:builtins.str, deviation_model:builtins.str, period:builtins.int) -> polars.Series:
        r"""
...
class MomentumTI:
    ...
    def aroon_indicator_single(self, lows:polars.Series) -> tuple[builtins.float, builtins.float, builtins.float]:
        ...
        * `PyResult<(f64, f64, f64)>` - Tuple containing (aroon_up, aroon_down, aroon_oscillator)
        """
    def long_parabolic_time_price_system_single(self, previous_sar:builtins.float, extreme_point:builtins.float, acceleration_factor:builtins.float, low:builtins.float) -> builtins.float:
        r"""
        ...
        * `PyResult<f64>` - The calculated SAR value for long positions
        """
    def short_parabolic_time_price_system_single(self, previous_sar:builtins.float, extreme_point:builtins.float, acceleration_factor:builtins.float, high:builtins.float) -> builtins.float:
        r"""
    ...
    def on_balance_volume_bulk(self, volume:polars.Series, previous_obv:builtins.float) -> polars.Series:
        ...
        * `PyResult<PySeriesStubbed>` - Series named "obv" containing cumulative OBV values
        """
    def commodity_channel_index_bulk(self, constant_model_type:builtins.str, deviation_model:builtins.str, constant_multiplier:builtins.float, period:builtins.int) -> polars.Series:
        r"""
        ...
        * `PyResult<PySeriesStubbed>` - Series named "cci" containing CCI values
        """
    def mcginley_dynamic_commodity_channel_index_bulk(self, previous_mcginley_dynamic:builtins.float, deviation_model:builtins.str, constant_multiplier:builtins.float, period:builtins.int) -> tuple[polars.Series, polars.Series]:
        r"""
        ...
        * `PyResult<(PySeriesStubbed, PySeriesStubbed)>` - Tuple containing (CCI series, McGinley Dynamic series)
        """
    def macd_line_bulk(self, short_period:builtins.int, short_period_model:builtins.str, long_period:builtins.int, long_period_model:builtins.str) -> polars.Series:
        r"""
    ...
    def signal_line_bulk(self, macds:polars.Series, constant_model_type:builtins.str, period:builtins.int) -> polars.Series:
        ...
        * `PyResult<PySeriesStubbed>` - Series named "signal" containing signal line values
        """
    def mcginley_dynamic_macd_line_bulk(self, short_period:builtins.int, previous_short_mcginley:builtins.float, long_period:builtins.int, previous_long_mcginley:builtins.float) -> polars.DataFrame:
        r"""
        ...
        * `PyResult<PyDfStubbed>` - DataFrame with columns: "macd", "short_mcginley", "long_mcginley"
        """
    def chaikin_oscillator_bulk(self, highs:polars.Series, lows:polars.Series, volume:polars.Series, short_period:builtins.int, long_period:builtins.int, previous_accumulation_distribution:builtins.float, short_period_model:builtins.str, long_period_model:builtins.str) -> tuple[polars.Series, polars.Series]:
        r"""
...
class StrengthTI:
    ...
    def accumulation_distribution(self, high:polars.Series, low:polars.Series, volume:polars.Series, previous_ad:typing.Optional[builtins.float]) -> polars.Series:
        r"""
    ...
    def negative_volume_index(self, volume:polars.Series, previous_nvi:typing.Optional[builtins.float]) -> polars.Series:
        ...
        """
    def relative_vigor_index(self, open:polars.Series, high:polars.Series, low:polars.Series, constant_model_type:builtins.str, period:builtins.int) -> polars.Series:
        r"""
        ...
        """
    def single_accumulation_distribution(self, high:builtins.float, low:builtins.float, volume:builtins.float, previous_ad:typing.Optional[builtins.float]) -> builtins.float:
        r"""
...
class TrendTI:
    ...
    def aroon_indicator_bulk(self, lows:polars.Series, period:builtins.int) -> polars.DataFrame:
        ...
        """
    def parabolic_time_price_system_bulk(self, lows:polars.Series, acceleration_factor_start:builtins.float, acceleration_factor_max:builtins.float, acceleration_factor_step:builtins.float, start_position:builtins.str, previous_sar:builtins.float) -> polars.Series:
        r"""
        ...
        """
    def directional_movement_system_bulk(self, lows:polars.Series, closes:polars.Series, period:builtins.int, constant_model_type:builtins.str) -> polars.DataFrame:
        r"""
    ...
    def volume_price_trend_bulk(self, volumes:polars.Series, previous_volume_price_trend:builtins.float) -> polars.Series:
        ...
        """
    def true_strength_index_bulk(self, first_constant_model:builtins.str, first_period:builtins.int, second_constant_model:builtins.str, second_period:builtins.int) -> polars.Series:
        r"""
...
class VolatilityTI:
    ...
    def ulcer_index_bulk(self, price_column:builtins.str, period:builtins.int) -> polars.Series:
        ...
        """
    def volatility_system(self, high_column:builtins.str, low_column:builtins.str, close_column:builtins.str, period:builtins.int, constant_multiplier:builtins.float, constant_model_type:builtins.str) -> polars.Series:
        r"""
